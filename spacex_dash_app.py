...
# Add a callback function for `id` as input, `success-pie-chart` as output
...
# Add a callback function for `id` and `payload-slider` as inputs, `success-payload-scatter-chart` as output
